# 1 "d:\\arduino-1.8.10\\sketch_WorkSpace\\ESP8266WiFiSTA\\esp8266WiFiSTA.ino"
# 2 "d:\\arduino-1.8.10\\sketch_WorkSpace\\ESP8266WiFiSTA\\esp8266WiFiSTA.ino" 2
...
void setup()
{
    ...
    /* 配置WiFi的工作模式为Station */
    /* 连接到路由器 */
    WiFi.begin("my_Wifi_1st", "qianrushi");
    /* 设置自动连接 */
    ...
    Serial.print(String("Connecting to ") + "my_Wifi_1st");
